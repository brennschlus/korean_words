...
/* package korean-0.1.0.0 */
#ifndef VERSION_korean
#define VERSION_korean "0.1.0.0"
#endif /* VERSION_korean */
#ifndef MIN_VERSION_korean
#define MIN_VERSION_korean(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_korean */
...
#define CURRENT_COMPONENT_ID "korean-0.1.0.0-inplace-korean"
